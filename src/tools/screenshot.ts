...
export function registerScreenshotTools(server: McpServer) {
  server.tool(
    "take_screenshot",
    "Take a screenshot of the emulator screen and return it as a base64 image",
  ...
  server.tool(
    "record_screen",
    "Record the emulator screen for a given number of seconds and save to a local file",
    {
